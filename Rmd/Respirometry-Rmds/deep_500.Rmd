...
files <- list.files(path ="./data/Ch2/respirometry/deep/500/", pattern = "*_cleaned.txt", full.names = T)
...
for (col in data_cols) {
    ...
    pdf(paste0('data/Ch2/respirometry/deep/500/check_plots/', col, "_500", ".pdf"))
    inspect(data_subset)
...
#### Photosynthesis Calculations ####
    ...
    pdf(paste0('data/Ch2/respirometry/deep/500/full_plots/', Geno, "_photo.pdf"))
    plot(photo)
    dev.off()
...
#### Respiration calculations ####
    ...
    pdf(paste0('data/Ch2/respirometry/deep/500/full_plots/', Geno, "_resp.pdf"))
    print(resp)
    dev.off()
...
library("writexl")
write_xlsx(final_combined, "data/Ch2/respirometry/deep/final_rates/500_rates.xlsx")

write.csv(final_combined, "data/Ch2/respirometry/deep/final_rates/500_rates.csv", row.names = FALSE)

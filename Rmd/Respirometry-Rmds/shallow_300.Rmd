...
files <- list.files(path ="./data/Ch2/respirometry/shallow/300/", pattern = "*_cleaned.txt", full.names = T)
...
for (col in data_cols) {
    ...
    pdf(paste0('data/Ch2/respirometry/shallow/300/check_plots/', col, "_300", ".pdf"))
    inspect(data_subset)
...
#### Photosynthesis Calculations ####
    ...
    pdf(paste0('data/Ch2/respirometry/shallow/300/full_plots/', Geno, "_photo.pdf"))
    plot(photo)
    dev.off()
...
#### Respiration calculations ####
    ...
    pdf(paste0('data/Ch2/respirometry/shallow/300/full_plots/', Geno, "_resp.pdf"))
    print(resp)
    dev.off()
...
library("writexl")
write_xlsx(final_combined, "data/Ch2/respirometry/shallow/final_rates/300_rates.xlsx")

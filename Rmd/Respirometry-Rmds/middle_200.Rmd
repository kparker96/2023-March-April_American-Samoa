...
files <- list.files(path ="./data/respirometry/middle/200/", pattern = "*_cleaned.txt", full.names = T)
...
for (col in data_cols) {
    ...
    pdf(paste0('data/respirometry/middle/200/check_plots/', col, "_200", ".pdf"))
    inspect(data_subset)
...
#### Photosynthesis Calculations ####
    ...
    pdf(paste0('data/respirometry/middle/200/full_plots/', Geno, "_photo.pdf"))
    plot(photo)
    dev.off()
...
#### Respiration calculations ####
    ...
    pdf(paste0('data/respirometry/middle/200/full_plots/', Geno, "_resp.pdf"))
    print(resp)
    dev.off()
...
library("writexl")
write_xlsx(final_combined, "data/respirometry/middle/final_rates/200_rates.xlsx")

write_csv(final_combined, "data/respirometry/middle/final_rates/200_rates.csv")
